...
Endpoint::Endpoint(const RoleAttributes& attr)
  ...
  std::cout << "host_name---" << attr_.host_name() << std::endl;
  std::cout << "process_id----" << attr_.process_id() << std::endl;
  std::cout << "id-----" << id_.HashValue() << std::endl;

  std::cout << "HostName  ==  " << common::GlobalData::Instance()->HostName() << std::endl;
  std::cout << "process_id  == " << common::GlobalData::Instance()->ProcessId() << std::endl;
  std::cout << "id_.HashValue()  ==  " << id_.HashValue() << std::endl;
